...
def read_add_emp():
    # 读取数据
    emp_path = os.path.dirname(os.path.abspath(__file__)) + "/data/emp.json"
...
def read_query_emp():
    ...
    with open(emp_path, mode='r', encoding='utf-8') as f:
        ...
        query_emp_data = jsonData.get('query_emp')  # 读取json文件中的数据
...
def read_modify_emp():
    ...
    with open(emp_path, mode='r', encoding='utf-8') as f:
        ...
        username = modify_emp_data.get("username")# 读取json文件中的数据
...
def read_delete_emp():
    ...
    with open(emp_path, mode='r', encoding='utf-8') as f:
        ...
        delete_emp_data = jsonData.get('delete_emp')  # 读取json文件中的数据
